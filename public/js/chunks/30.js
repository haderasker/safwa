                  ...
                  _c("div", { staticClass: "vx-row" }, [
                    _c("div", { staticClass: "vx-col w-1/3" }, [
                      _c(
                        "a",
                        {
                          attrs: { href: _vm.lesson.youtube, target: "_blank" }
                        },
                        [
                          _c("statistics-card-line", {
                            staticClass: "mb-base",
                    ...
                    _c("div", { staticClass: "vx-col w-1/3" }, [
                      _c(
                        "a",
                        { attrs: { href: _vm.lesson.pdf, target: "_blank" } },
                        [
                          _c("statistics-card-line", {
                            staticClass: "mb-base",
                            attrs: {
                              hideChart: "",
                              icon: "FileTextIcon",
                              statistic: _vm.$t("student_lesson_profile.pdf")
                            }
                          })
                        ],
                        1
