...
export default {
  ...
  computed: {
    navbarSearchAndPinList () {
      return {pages: this.$store.state.Default.navbarSearchAndPinList['pages']}
    },
    starredPages () {
    ...
    textColor () {
      return {'text-white': this.$store.state.Default.mainLayoutType === 'vertical' && this.navbarColor !== (this.$store.state.Default.theme === 'dark' ? '#10163a' : '#fff') }
    }
  },
  methods: {
    selected (obj) {
