...
export default {
  ...
  computed: {
    ...
    isThemedark ()          { return this.$store.state.Default.theme                                                                       },
    ...
    scrollY ()              { return this.$store.state.Default.scrollY                                                                     },
    verticalNavMenuWidth () { return this.$store.state.Default.verticalNavMenuWidth                                                        },
